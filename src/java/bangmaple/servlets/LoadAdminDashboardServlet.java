...
public class LoadAdminDashboardServlet extends HttpServlet {
    ...
    private static final String SUCCESS = "genericDashboard.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("uSize", uDAO.size());
            request.setAttribute("rSize", rDAO.size());
            request.setAttribute("eSize", eDAO.size());
            url = SUCCESS;
        } catch (Exception e) {
            log("ERROR at LoadAdminDashboardServlet: " + e.getMessage());
        } finally {
