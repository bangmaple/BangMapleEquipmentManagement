...
public class ChangePasswordController extends HttpServlet {
    ...
    private static final String SUCCESS = "adminDashboard";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.changePassword(((Users)request.getSession().getAttribute("userInfo")).getUsername(), password);
            url = SUCCESS;
            request.setAttribute("changePasswordSuccessful", "");
        } catch (Exception e) {
