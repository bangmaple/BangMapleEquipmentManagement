 ...
 * @author bangmaple
 */
public class DisableEquipmentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.disableOrEnableEquipment(equipmentID);
            url = SUCCESS;
        } catch (Exception e) {
            log("ERROR at DisableEquipmentController: " + e.getMessage());
        } finally {
