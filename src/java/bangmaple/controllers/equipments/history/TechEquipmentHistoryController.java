 ...
 * @author bangmaple
 */
public class TechEquipmentHistoryController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "tech/techEquipmentHistory.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<EquipmentsReq> list = dao.getAllEquipResbyTech(((Users)request.getSession().getAttribute("userInfo")).getUsername());
            ...
            log("ERROR at TechEquipmentHistoryController: " + e.getMessage());
        } finally {
