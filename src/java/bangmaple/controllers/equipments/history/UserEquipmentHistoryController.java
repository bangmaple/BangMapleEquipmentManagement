 ...
 * @author bangmaple
 */
public class UserEquipmentHistoryController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "users/userEquipmentHistory.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<EquipmentsReq> list = dao.getAllEquipReqByUser(((Users)request.getSession().getAttribute("userInfo")).getUsername());
            ...
            log("ERROR at UserEquipmentHistoryController: " + e.getMessage());
        } finally {
