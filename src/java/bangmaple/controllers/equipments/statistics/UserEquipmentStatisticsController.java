 ...
 * @author bangmaple
 */
public class UserEquipmentStatisticsController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "users/equipmentStatistics.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action == null) {
                List<EquipmentsUsingByUsers> list = dao.getAllCurrentUsingByUser(((Users) request.getSession().getAttribute("userInfo")));
                ...
                if (dateFrom.length() == 0 || dateTo.length() == 0) {
                    ...
                    List<EquipmentsUsingByUsers> list = dao.getAllCurrentUsingDateRangeByUser(sdf.parse(dateFrom), sdf.parse(dateTo), ((Users)request.getSession().getAttribute("userInfo")).getUsername());
                    request.setAttribute("INFO", list);
                }
                ...
                if (repairTime.length() == 0) {
                    ...
                    List<EquipmentsUsingByUsers> list = dao.getAllCurrentUsingRepairTimeByUser(Integer.parseInt(repairTime), ((Users)request.getSession().getAttribute("userInfo")).getUsername());
                    request.setAttribute("INFO", list);
                }
            }
