 ...
 * @author bangmaple
 */
public class ViewMoreEquipInfoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("equipViewInfoModal", "");
            if (e.getEquipImage() == null) {
                request.setAttribute("equipImage",  "uploads/noImage.jpg");
            } else {
                request.setAttribute("equipImage", "uploads/equipments/" + e.getEquipImage());
            }
            url = SUCCESS;
        } catch (Exception e) {
            log("ERROR at ViewMoreEquipInfoController: " + e.getMessage());
        } finally {
