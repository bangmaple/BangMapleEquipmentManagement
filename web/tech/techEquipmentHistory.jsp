...
<html lang="en">
    ...
    <body id="page-top">
        <%@include file="techEquipmentHistoryHeadBodyScript.jsp" %>
        <!-- Page Wrapper -->
        <div id="wrapper">
            <!--Sidebar-->
                ...
                <div id="content">
                    ...
                    <c:if test="${sessionScope.userInfo != null}">
                        ...
                        <div class="container-fluid">
                            <!-- Page Heading -->
                            <%@include file="techEquipmentHistoryHeading.html" %>
                            <!-- DataTales Example -->
                                                    ...
                                                    <c:if test="${not empty requestScope.INFO}" var="checkList">
                                                        <c:forEach var="dto" items="${requestScope.INFO}" varStatus="counter">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form action="techEquipmentHistory" method="POST">
        ...
        <%@include file="techEquipmentHistorySettingsModal.jsp" %>
