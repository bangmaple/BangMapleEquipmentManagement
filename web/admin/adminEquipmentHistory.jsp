...
<html lang="en">
    ...
    <body id="page-top">
        <%@include file="adminEquipmentHistoryHeadBodyScript.jsp" %>
        <!-- Page Wrapper -->
        <div id="wrapper">
            <!--Sidebar-->
                ...
                <div id="content">
                    ...
                    <c:if test="${sessionScope.userInfo != null}">
                        ...
                        <div class="container-fluid">
                            <!-- Page Heading -->
                            <%@include file="adminEquipmentHistoryHeading.html" %>
                            <!-- DataTales Example -->
                                                    ...
                                                    <c:if test="${not empty requestScope.INFO}" var="checkList">
                                                        <c:forEach var="dto" items="${requestScope.INFO}" varStatus="counter">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form action="adminEquipmentHistory" method="POST">
        ...
        <a class="scroll-to-top rounded" href="#page-top"><i class="fas fa-angle-up"></i></a>
            <%@include file="adminEquipmentHistorySettingsModal.jsp" %>
