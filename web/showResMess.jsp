                ...
                <div id="content">
                    ...
                    <c:if test="${sessionScope.userInfo != null}">
                        ...
                        <div class="container-fluid">
                            <!-- Page Heading -->
                            <%@include file="resMess/heading.html" %>
                            <!-- DataTales Example -->
                                        ...
                                        <table class="table table-bordered" id="dataTableAlert" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <c:if test="${applicationScope.resList ne null}">
                                                    <c:if test="${not empty applicationScope.resList}" var="checkList">
                                                        <c:forEach var="dto" items="${applicationScope.resList}" varStatus="counter">
                                                            <tr>
